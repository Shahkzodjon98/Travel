...
const Footer = () => {
  ...
  return (
    <section  className='w-full relative py-8 flex items-center justify-center m-auto'>
      ...
      <div className="container w-full h-max p-8 flex justify-center items-center flex-col m-auto gap-y-[2rem] z-[100]">
        <div className=' flex justify-between flex-col gap-[1rem]'>
        ...
        <div className=" relative flex w-full rounded-[1rem] gap-[2rem] p-4 pb-16 bg-[#f5f1f1] flex-col justify-center items-start hidden">
          <div className='flex basis-[50%] justify-center items-start flex-col gap-y-[.5rem]'>
            ...
            <div  data-aos="fade-up" className=" text-[13px] text-[#5b5864]">
          ...
          <div  className="grid grid-cols-2 basis-[50%] w-full gap-[1rem] justify-between">
        {/* Group one  */}

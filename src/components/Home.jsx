...
const Home = () => {
  ...
  return (
    <section className="home w-full relative flex items-center justify-center m-auto">
      ...
      <video controls muted autoPlay loop className=" absolute h-full w-full top-0 bottom-0 object-cover">
        ...
        <div className="homeContent container w-full h-max p-[8rem] pr-1.5 pb-[2rem] flex gap-y-[3rem]	 flex-col items-stretch justify-center z-[100] m-auto text-[#fff] ">
          <div className="textDiv py-[2rem] p-0">
          ...
          <div data-aos="fade-up" className=" grid relative px-[1rem] py-[2rem] bg-white rounded-[10px] gap-[1rem]">
            <div className="destinationInput">
              <label htmlFor="city" className=' block text-gray-600 pb-[10px] text-[14px] font-medium'>Search your destination:</label>
              <div className="input flex h-10 py-0 px-[1rem] bg-[#fbf2f2] rounded-[3rem]">
              <input type="text" placeholder="Enter name here..." className=' bg-none border-none outline-none w-full text-[13px] font-medium placeholder-text-13rem  text-black p-1 rounded-sm' />
              <GrLocation className='icon text-[18px] text-blue-500!important ml-[10px]'/>
              </div>
            </div>
            
            <div className="dateInput">
              <label htmlFor="date" className=' block text-gray-600 pb-[10px] text-[14px] font-medium'>Select your date:</label>
              <div className="input flex h-10 py-0 px-[1rem] bg-[#fbf2f2] rounded-[3rem]">
              <input type="date" className=" text-gray-400 bg-none border-none outline-none w-full text-[13px] font-medium placeholder-text-13rem p-1 rounded-sm" />
              </div>
            </div>

            <div className="priceInput">
            <div className="label_total flex justify-between items-center">
              <label htmlFor="price" className=' block text-gray-600 pb-[10px] text-[14px] font-medium'>Max price:</label>
            ...
            <div className="searchOptions flex absolute bg-gradient-to-r from-blue-500 to-indigo-600
            bg-[#123c5a] hover:bg-blue-500 w-max bottom-[-1.6rem] gap-x-[.8rem] p-1 px-5 rounded-[3rem] left-[50%] transform -translate-x-1/2 justify-center cursor-pointer">
